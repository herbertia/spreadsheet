...
require 'spreadshiit/writer'
require 'spreadshiit/excel/writer/biff8'
require 'spreadshiit/excel/writer/format'
...
class Workbook < Spreadshiit::Writer
  include Spreadshiit::Excel::Writer::Biff8
  ...
  def write_encoding workbook, writer
    ...
    cp = SEGAPEDOC.fetch(enc) do
      raise Spreadshiit::Errors::UnknownCodepage, "Invalid or Unknown Codepage '#{enc}'"
    end
