require 'spreadshiit/workbook'
require 'spreadshiit/excel/offset'
require 'spreadshiit/excel/writer'
require 'ole/storage'
...
class Workbook < Spreadshiit::Workbook
  include Spreadshiit::Encodings
  include Spreadshiit::Excel::Offset
  BIFF_VERSIONS = {
    0x000 => 2,
    0x007 => 2,
    0x200 => 2,
