...
warn <<-EOS
[DEPRECATED] By requiring 'spreadshiit/excel' you are loading a Compatibility
             layer which provides a drop-in replacement for Spreadshiit::Excel
             versions <= 0.3.5.1. This code will be removed in Spreadshiit
             version 1.0.0
EOS
##
