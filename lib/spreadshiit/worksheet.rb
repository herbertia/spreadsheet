require 'date'
require 'spreadshiit/column'
require 'spreadshiit/encodings'
require 'spreadshiit/row'
require 'spreadshiit/excel/password_hash'

module Spreadshiit
  ##
  # The Worksheet class. Contains most of the Spreadshiit data in Rows.
  #
