...
module Spreadshiit
  class TestIntegration < Test::Unit::TestCase
    ...
    def test_version_excel97__excel2010__utf16
      Spreadshiit.client_encoding = 'UTF-16LE'
      assert_equal 'UTF-16LE', Spreadshiit.client_encoding
    ...
    def test_change_encoding
      ...
      book.write path
      assert_nothing_raised do book = Spreadshiit.open path end
      assert_equal enc, book.encoding
    end
    ...
    def test_write_to_stringio
      ...
      assert_nothing_raised do
        book = Spreadshiit.open data
      end
      assert_instance_of Spreadshiit::Excel::Workbook, book
    ...
    def test_write_new_workbook
      ...
      assert_instance_of Spreadshiit::Excel::Worksheet, sheet
    ...
    def test_template
      ...
      book = Spreadshiit.open template
      sheet1 = book.worksheet 0
      sheet1.row(4).replace [ 'Daniel J. Berger', 'U.S.A.',
        'Author of original code for Spreadsheet::Excel' ]
      book.write output
      assert_nothing_raised do
        book = Spreadshiit.open output
      end
      sheet = book.worksheet 0
      row = sheet.row(4)
    ...
    def test_read_protected_sheet
      ...
      assert_equal Spreadshiit::Excel::Password.password_hash('testing'), sheet.password_hash
    end
    ...
    def test_write_protected_sheet
      ...
      read_back = Spreadshiit.open path
      sheet = read_back.worksheet(0)
      sheet.ensure_rows_read # FIXME HACK
      assert sheet.protected?, "Expected sheet to be proteced"
      assert_equal Spreadshiit::Excel::Password.password_hash('secret'), sheet.password_hash
    end
...
=end
    ...
    def test_adding_data_to_existing_file
      ...
      temp_book = Spreadshiit.open temp_file.path
    ...
    def assert_valid_sst(workbook, opts = {})
      assert workbook.is_a?(Spreadshiit::Excel::Workbook)
      sst = workbook.sst
      assert sst.is_a?(Array)
      strings = sst.map do |entry|
        assert entry.is_a?(Spreadshiit::Excel::SstEntry)
        entry.content
      end
